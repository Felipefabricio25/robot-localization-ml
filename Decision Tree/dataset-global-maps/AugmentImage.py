...
for i in range(0,3420,5):
    ...
    image = imageio.imread(f"/home/admsistemas/Documents/DatasetGlobalMaps/{filename}/botanic_map_{filename}.png")
    ...
    for i in range(100):
        ...
        imageio.imwrite(f'/home/admsistemas/Documents/DatasetGlobalMaps/{filename}/botanic_map_{filename}_{i}_{rand}.png', images_aug)
